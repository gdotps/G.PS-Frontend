...
import { Search, Bell, Clock, MapPin, Users } from 'lucide-react';
  ...
  return (
    <div className="pt-16 pb-24 px-4 space-y-6">
      <div className="flex justify-between items-end">
        <div>
           <p className="text-gray-500 text-sm font-medium mb-1">서울시 강남구 역삼동</p>
           <h2 className="text-2xl font-bold text-gray-900">내 주변 팟 찾기</h2>
        </div>
        <div className="flex gap-2">
            <button className="p-2 text-gray-500 hover:bg-gray-100 rounded-full"><Search size={20}/></button>
            <button 
      ...
      <div className="space-y-4">
        {filteredPosts.length === 0 ? (
            ...
            >
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 leading-snug group-hover:text-gray-600 transition-colors">{post.title}</h3>
